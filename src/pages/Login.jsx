...
const Login = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-b from-emerald-700 from-50% to-gray-800 to-50% space-y-8">
            <h2 className="font-libre text-4xl font-bold text-white drop-shadow-md">
            ...
            <div className="border shadow p-6 w-80 bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <button
                            type="submit"
                            className={`w-full bg-teal-500 text-white py-2 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            disabled={loading}
                        >
